...
(function () {
  ...
  const T = {
    ...
    'met.1': { ru: 'Пиковый MAU продукта', en: 'Peak Product MAU' },
    ...
    'met.4': { ru: 'Селлеров под руководством', en: 'Sales Team Members Led' },
    ...
    'exp.2.b1': { ru: 'Вёл закупку TMA-трафика по CPA: торговался, снижал ставки и согласовывал объёмы и условия.', en: 'Managed CPA-based TMA traffic acquisition: negotiated pricing, reduced rates, and agreed volumes and terms.' },
    ...
    'exp.3.b1': { ru: 'Апрель–июнь: в составе команды развивал сеть из 170+ амбассадоров и KOL — поиск, привлечение, поддержка и контроль через реферальные ссылки.', en: 'Apr–Jun: contributed to developing a 170+ ambassador and KOL network through sourcing, outreach, support, and referral-link tracking.' },
    ...
    'exp.3.b4': { ru: 'После повышения руководил командой из 12 селлеров: обучение, поддержка, разбор ошибок и проверка результатов.', en: 'After promotion, led a team of 12 salespeople: training, support, error review, and performance checks.' },
    ...
    'exp.5.b1': { ru: 'Исследовал крипторынок, находил перспективные проекты и практические возможности заработка для участников сообщества.', en: 'Researched the crypto market, identified promising projects, and evaluated potential earnings opportunities.' },
    'exp.5.b2': { ru: 'Оценивал механику проектов, рыночный контекст и ключевые риски; формулировал выводы для принятия решений.', en: 'Assessed project mechanics, market context, and key risks, then summarized findings for decision-making.' },
    'exp.6.role': { ru: 'Подготовка к ЕГЭ', en: 'Exam Preparation' },
    'exp.6.company': { ru: 'Школа', en: 'School' },
    'exp.6.period': { ru: 'Дек 2024 – Июн 2026', en: 'Dec 2024 – Jun 2026' },
    'exp.6.b1': { ru: 'Сосредоточился на завершении 11 класса и подготовке к ЕГЭ, сознательно приостановив полноценную коммерческую работу.', en: 'Focused on completing the 11th grade and preparing for final exams, consciously pausing full-time commercial work.' },
    'exp.6.b2': { ru: 'Параллельно развивал собственные проекты.', en: 'Continued developing independent projects in parallel.' },
    ...
    'wins.3': { ru: 'Участвовал в развитии сети из 170+ KOL и амбассадоров — DAU с 300k до 1.2M, MAU с 400k до 3.4M', en: 'Contributed to scaling a 170+ KOL and ambassador network — DAU from 300k to 1.2M, MAU from 400k to 3.4M' },
    ...
    'wins.1.example': { ru: 'В Cherry Game находил и оценивал источники TMA-трафика, торговался по CPA-ставкам и согласовывал объёмы и условия. Это позволило масштабировать MAU продукта с 1.8M до 6M+ менее чем за четыре месяца.', en: 'At Cherry Game, sourced and evaluated TMA traffic, negotiated CPA rates, and agreed volumes and terms. This enabled the product to scale from 1.8M to 6M+ MAU in under four months.' },
    ...
    'wins.3.example': { ru: 'В Diamore вместе с командой развивал сеть из 170+ амбассадоров и KOL. После перехода в продажи стал лучшим продавцом по результату, а после повышения руководил 12 селлерами.', en: 'At Diamore, worked with the team to develop a network of 170+ ambassadors and KOLs. After moving into sales, became the top seller by results and later led a team of 12 salespeople.' },
