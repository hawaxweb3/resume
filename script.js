...
(function () {
  ...
  const T = {
    ...
    'exp.sub': { ru: 'Роли в росте и монетизации — Web3, GameFi, digital', en: 'Revenue and growth roles across Web3, GameFi, and digital products' },
    'exp.1.role': { ru: 'Web3 Growth & Revenue Lead', en: 'Web3 Growth & Revenue Lead' },
    'exp.1.period': { ru: 'Фев 2025 – Ноя 2025', en: 'Feb 2025 – Nov 2025' },
    'exp.1.b1': { ru: 'Запустил MVP с нуля — готовый к монетизации с первого дня', en: 'Shipped revenue-ready MVP from zero to live' },
    'exp.1.b2': { ru: 'Поднял активацию на 25%, что напрямую увеличило конверсию в платящих', en: 'Drove +25% activation — directly improving monetization conversion' },
    'exp.1.b3': { ru: 'Увеличил аудиторию на 30–40% по MAU, внедрив продуктовые механики монетизации', en: 'Grew monetizable audience 30–40% MAU by shipping revenue-driving product mechanics' },
    'exp.1.b4': { ru: 'Сократил путь до первого платного действия на 37%', en: 'Cut time-to-revenue-action by 37%' },
    'exp.1.b5': { ru: 'Поднял ARPU на 20–25%, перестроив систему монетизации с нуля', en: 'Raised ARPU 20–25% by designing and launching a rebuilt monetization system' },
    'exp.1.b6': { ru: 'Управлял командами разработки, дизайна и маркетинга для ускорения выхода на рынок', en: 'Directed dev, design, and marketing teams to accelerate time-to-revenue launch' },
    'exp.2.role': { ru: 'Менеджер по закупке трафика и росту', en: 'Media Buying & Growth Manager' },
    ...
    'exp.2.b3': { ru: 'Выстроил CPA-модель с лучшей юнит-экономикой на рынке', en: 'Built best-in-market CPA acquisition model by unit economics' },
    'exp.2.b4': { ru: 'Закрыл стратегическую сделку — доходность 350% чистой прибыли', en: 'Closed strategic partnership deal — 350% net profit return' },
    'exp.3.role': { ru: 'Бизнес-развитие / Руководитель продаж / Амбассадорская программа', en: 'BizDev / Head of Sales / Ambassador Lead' },
    'exp.3.period': { ru: 'Май 2024 – Сен 2024', en: 'May 2024 – Sep 2024' },
    'exp.3.b1': { ru: 'Построил и управлял сетью из 170+ амбассадоров и KOL', en: 'Built and ran 170+ ambassador & KOL partner network' },
    ...
    'exp.3.b4': { ru: 'Закрыл $27k в прямых личных продажах', en: 'Closed $27k in personal direct sales' },
    ...
    'exp.5.role': { ru: 'Ассистент системного администратора / Аналитик', en: 'Assistant SysAdmin / Research Analyst' },
    ...
    'wins.4': { ru: 'Построил системы монетизации с нуля: ARPU вырос на 20–25%, активация — на 25%, путь до первой оплаты сократился на 37%.', en: 'Built revenue systems from zero — ARPU up 20–25%, activation conversion up 25%, time-to-revenue-action cut 37%.' },
    ...
    'wins.4.example': { ru: 'В Mind FLUX / Pepr DEX запустил MVP с нуля с минимальными ресурсами — готовый к монетизации с первого дня. Прямые результаты: ARPU +20–25%, активация +25%, путь до первой оплаты сократился на 37%.', en: 'At Mind FLUX / Pepr DEX I shipped a revenue-ready MVP from zero to production with minimal resources. The direct monetization impact: ARPU up 20–25%, activation up 25%, time-to-revenue-action cut 37%.' },
    'proj.h': { ru: 'Собственные проекты', en: 'Founder Projects' },
    'proj.sub': { ru: 'Стартапы, запущенные с нуля', en: 'Ventures built from zero' },
    ...
    'proj.2.label': { ru: 'Сооснователь', en: 'Co-Founder' },
    ...
    'proj.3.label': { ru: 'Основатель', en: 'Founder' },
    ...
    'edu.h': { ru: 'Образование', en: 'Education' },
    'edu.name': { ru: 'РЭУ им. Г.В. Плеханова', en: 'Plekhanov Russian University of Economics' },
    'edu.p1': { ru: 'Менеджмент', en: 'Management' },
    'edu.p2': { ru: 'Маркетинг', en: 'Marketing' },
