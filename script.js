...
(function () {
  ...
  const T = {
    ...
    'wins.1.example': { ru: 'В Cherry Game находил и оценивал источники TMA-трафика, согласовывал стоимость привлечения пользователей, объёмы и условия. Это позволило масштабировать MAU продукта с 1.8M до 6M+ менее чем за четыре месяца.', en: 'At Cherry Game, sourced and evaluated TMA traffic, negotiated user acquisition costs, volumes, and terms. This enabled the product to scale from 1.8M to 6M+ MAU in under four months.' },
    ...
    'wins.3.example': { ru: 'В Diamore вместе с командой развивал сеть из 170+ амбассадоров и KOL.', en: 'At Diamore, worked with the team to develop a network of 170+ ambassadors and KOLs.' },
