...
(function () {
  ...
  const T = {
    ...
    'exp.3.b4': { ru: 'Лично закрыл $27k в прямых продажах; ещё более $40k принесла команда под моим руководством', en: 'Personally closed $27k in direct sales, while the team I led generated an additional $40k+' },
